...
/* Which dashboard, asked once after signing in.
 *
 * On this branch `/` is the product's landing page, so the chooser lives here
 * and the login sends you to it. Two dashboards read the same data and the
 * same scanners — this only decides which one you land in. */
